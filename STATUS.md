...
- 已重建 `v3.7.0` 本地安装包：13 个可安装文件与源码逐项 SHA256 一致，zip SHA256 为 `0A6481F284E451DE3786AD68FCA2B346EC0CB8D3C1B45430D7ABA111143CBA6B`，大小 `62728` 字节；`git diff --check` 通过。
- 已提交、推送并创建 GitHub `v3.7.0` 标签；安装包直链为 `https://github.com/xiujiayou888-xiuxiu/project-workflow/raw/refs/tags/v3.7.0/project-workflow-skill.zip`。GitHub CLI 的 Release 令牌已失效，因此本次以 GitHub 标签和可直接下载的安装包发布，`v3.6.0` Release 保持不变。
